...
public class SymmetricMatrixGenTest {
    ...
    private static String TEST_OUTPUT = "/home/arian/IdeaProjects/MyTestProject/anotherinput";

    @Test
    public void testGraphGenerator() throws Exception {
        try(PrintWriter printWriter = new PrintWriter("/home/arian/IdeaProjects/MyTestProject/anothergraph.txt", "UTF-8")) {

            Configuration conf = new Configuration();

            SymmetricMatrixGen.main(new String[] { "6", "2", TEST_OUTPUT, "1" });
